...
class Program
{
    static void Main()
    {
        ...
        sumAngle = sumAngle.Add(pAngle, cAngle);
        ...
        // Суммируем значения функции (например, округленные градусы)
        int totalDegrees = 0;
        ...
        Console.WriteLine("Сумма округленных градусов всех элементов массива: " + totalDegrees);
    }
}
